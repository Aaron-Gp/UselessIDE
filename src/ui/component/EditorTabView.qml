...
Item {
    ...
    property bool backgroundOpacity: true
    signal newPressed
    signal currentIndexChanged(string id)
    id:control
    ...
    ListView{
        ...
        onCurrentItemChanged: {
            if(currentItem!=null){
                control.currentIndexChanged(tab_model.get(currentIndex).id)
            }else{
    ...
    FluContentDialog{
        ...
        title:"保存"
        message:{
            if(tab_nav.currentItem!=null){
                "将修改保存到 "+tab_model.get(tab_nav.currentIndex).text;
            }else{
                " "
            }
        }
    ...
    function createTab(icon,title,page,id, argument){
        return {icon:icon,title:title,page:page,id:id,argument:argument}
    }
    function appendTab(icon,title,page,id,argument){
        tab_model.append(createTab(icon,title,page,id,argument))
    }
